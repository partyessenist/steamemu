// STEAMUGC_INTERFACE_VERSION004 -- inter-release interface version, ABSENT from the Steamworks
...
#define STEAMEMU_INTER_INTERFACE_VERSION "STEAMUGC_INTERFACE_VERSION004"
