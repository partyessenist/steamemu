// SteamFriends010 -- inter-release interface version, ABSENT from the Steamworks
...
#define STEAMEMU_INTER_INTERFACE_VERSION "SteamFriends010"
...
public:
	...
	virtual CSteamID GetChatMemberByIndex( CSteamID groupID, int iIndex ) = 0; /*virtual CSteamID GetChatMemberByIndex( CSteamID groupID, int iIndex ) = 0;*/
