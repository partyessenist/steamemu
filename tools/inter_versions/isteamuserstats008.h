// STEAMUSERSTATS_INTERFACE_VERSION008 -- inter-release interface version, ABSENT from the Steamworks
...
#define STEAMEMU_INTER_INTERFACE_VERSION "STEAMUSERSTATS_INTERFACE_VERSION008"
