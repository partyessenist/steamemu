// SteamFriends012 -- inter-release interface version, ABSENT from the Steamworks
// SDK git history (it shipped between two release-granularity commits).
// Parsed by tools/oldversions.py exactly like a git-history header.
// Vtable order is ABI -- do not reorder or edit method declarations.
#define STEAMEMU_INTER_INTERFACE_VERSION "SteamFriends012"
...
public:
	...
	virtual CSteamID GetFriendByIndex( int iFriend, int iFriendFlags ) = 0; /*virtual CSteamID GetFriendByIndex( int iFriend, int iFriendFlags ) = 0;*/
	...
	virtual CSteamID GetFriendFromSourceByIndex( CSteamID steamIDSource, int iFriend ) = 0; /*virtual CSteamID GetFriendFromSourceByIndex( CSteamID steamIDSource, int iFriend ) = 0;*/
	...
	virtual CSteamID GetCoplayFriend( int iCoplayFriend ) = 0; /*virtual CSteamID GetCoplayFriend( int iCoplayFriend ) = 0;*/
	...
	virtual CSteamID GetChatMemberByIndex( CSteamID steamIDClan, int iUser ) = 0; /*virtual CSteamID GetChatMemberByIndex( CSteamID steamIDClan, int iUser ) = 0;*/
