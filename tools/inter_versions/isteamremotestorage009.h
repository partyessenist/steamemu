// STEAMREMOTESTORAGE_INTERFACE_VERSION009 -- inter-release interface version, ABSENT from the Steamworks
...
#define STEAMEMU_INTER_INTERFACE_VERSION "STEAMREMOTESTORAGE_INTERFACE_VERSION009"
