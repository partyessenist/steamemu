// STEAMTIMELINE_INTERFACE_V003 -- inter-release interface version, ABSENT from the Steamworks
...
#define STEAMEMU_INTER_INTERFACE_VERSION "STEAMTIMELINE_INTERFACE_V003"
